...
$(function(){	
	...
	$(".del").click(function(){
		...
		var url="${pageContext.request.contextPath}/admin/goods/delete";
		 if(confirm("是否操作")){
	         $.post(url,
	               {"id":id},
	               function(res){		            
		...
		<div class="div_clear">
			<div class="center_top">
				<div style="float:right;padding-right:6px">
					...
					<a href="${pageContext.request.contextPath}/admin/goods/edit?pageCode=${page.pageCode}">新增</a>&nbsp; 
					...
					<input type="button" value="批量下架" id="but" onclick="but()" disabled="disabled" />
				</div>
			</div>
		</div>
		 <a href="${root}/admin/common/ma" target="right" style="padding:0 25px;">错误页</a>
		<div class="div_clear">
			<div class="center_center">
				<div class="table_content">
					<table cellspacing="0px" cellpadding="0px">
						...
						<tbody>
							<form action="${pageContext.request.contextPath}/admin/goods/deleteAll" method="post" name="delForm">
