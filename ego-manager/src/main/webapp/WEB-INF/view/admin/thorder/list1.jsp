...
<html>
  <head>
    ...
    function goPage(currentPage){
    	/* alert(currentPage); */
        window.location.href= "${root}"+"/admin/thorder/list1?pageCode="+currentPage;	
    }
   </script>
  </head>
								...
								<div class="order-content"   >
									...
									<ul class="item-list">
											...
											<li class="td td-operation">
											    <div class="item-operation">退款</div>
										    </li>	
										</ul>
										   ...
										   <li class="td td-change">
											...
											<li class="td td-change">
												<div class="am-btn am-btn-danger anniu">
													<a  class="confirmGetOrder" name="${orderWithOrderItem.id}"  href="javascript:void(0)">同意退货</a>
													<input type="hidden" value="${orderWithOrderItem.snorders}">
												</div>
											</li>
