...
-- Records of admins
-- ----------------------------
INSERT INTO `admins` VALUES ('1', 'admin', 'admin', '2018-01-18 11:08:59', null);
...
CREATE TABLE `admins_roles` (
  ...
  KEY `roles` (`roles`),
  CONSTRAINT `admins_roles_ibfk_1` FOREIGN KEY (`admins`) REFERENCES `admins` (`id`),
  CONSTRAINT `admins_roles_ibfk_2` FOREIGN KEY (`roles`) REFERENCES `roles` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of admins_roles
-- ----------------------------
INSERT INTO `admins_roles` VALUES ('1', '1');
...
CREATE TABLE `area` (
  ...
  `citycode` varchar(18) DEFAULT NULL,
...
-- Records of cart
-- ----------------------------
INSERT INTO `cart` VALUES ('20', '18', '5a6599cc34e94c14585b4e59', '168.00', '3', 'F201801231208256138bc5672c2499da16edf2bcbb70647.jpg', '剃须刀', '2018-01-29 17:38:27', null);
INSERT INTO `cart` VALUES ('21', '18', '5a65d7f509bd9904b48fd232', '899.00', '6', 'F20180123120924f40f2be756e64d37ab999d5d1372c266.jpg', '硬盘', '2018-01-29 17:38:39', null);
INSERT INTO `cart` VALUES ('22', '18', '5a6599e234e94c1bb43ca8e8', '5399.00', '1', 'F2018012311253694222bfb8f8e4f55a41c2e6f056f7683.jpg', '显示器', '2018-01-29 17:54:39', null);
INSERT INTO `cart` VALUES ('24', '57', '5a6fc14fd5f6532fe089007e', '6900.00', '1', 'F20180130085023f57036dd5ba249ae88dcab1180317a58.jpg', '电脑', '2018-06-06 17:05:49', null);
...
CREATE TABLE `city` (
  ...
  `code` varchar(18) DEFAULT NULL,
  `name` varchar(60) DEFAULT NULL,
  `provincecode` varchar(18) DEFAULT NULL,
  KEY `code` (`code`),
...
CREATE TABLE `imgs` (
  ...
  PRIMARY KEY (`id`),
  KEY `stores` (`stores`),
  CONSTRAINT `imgs_ibfk_1` FOREIGN KEY (`stores`) REFERENCES `stores` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of imgs
-- ----------------------------
INSERT INTO `imgs` VALUES ('32', 'F201801221106367f315e3c14c14b809996a617dd4989eb.jpg', 'i8.jpg', '5a65553c5e90e61640248ac4', null);
INSERT INTO `imgs` VALUES ('33', 'F201801221106365e6d325e65384dbcaeb34cb7469d71a8.jpg', 's7.jpg', '5a65553c5e90e61640248ac4', null);
INSERT INTO `imgs` VALUES ('34', 'F201801221106361182a26e0d1c41a1bcbf865ff636b673.jpg', 'i8.jpg', '5a65553c5e90e61640248ac4', null);
INSERT INTO `imgs` VALUES ('35', 'F20180122115511c3bfaee83da24927ab91a403d71d1d5c.jpg', 's8.jpg', '5a65609f5e90e61e3cc7369b', null);
INSERT INTO `imgs` VALUES ('36', 'F20180122115511b5912be3bc774b08b31077ceb17ef635.jpg', 'timg.jpg', '5a65609f5e90e61e3cc7369b', null);
INSERT INTO `imgs` VALUES ('37', 'F201801221155118fcfaf25db234b458bbc9e21cd27c913.jpg', 's7.jpg', '5a65609f5e90e61e3cc7369b', null);
INSERT INTO `imgs` VALUES ('38', 'F201801221927011df5ee4a775343cd916911d133a2f995.jpg', '1 .jpg', '5a65ca8509bd990930ec0b05', null);
INSERT INTO `imgs` VALUES ('39', 'F20180122192701d23d9505e5ca49169996db3ae4eb937f.jpg', '2.jpg', '5a65ca8509bd990930ec0b05', null);
INSERT INTO `imgs` VALUES ('40', 'F20180122192701e8830b0f241043ed81cef25ea272668b.jpg', '4.jpg', '5a65ca8509bd990930ec0b05', null);
INSERT INTO `imgs` VALUES ('41', 'F201801221945338192b6d819c8415492ae3b954fc84afb.jpg', '0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg', '5a65cedd09bd990930ec0b06', null);
INSERT INTO `imgs` VALUES ('42', 'F2018012219453341d845ae1afc4228a1e0e4ea9684ac9b.jpg', '0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg', '5a65cedd09bd990930ec0b06', null);
INSERT INTO `imgs` VALUES ('43', 'F20180122194533883ae4a1871f47768f1b3141f59f4072.jpg', '0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg', '5a65cedd09bd990930ec0b06', null);
INSERT INTO `imgs` VALUES ('44', 'F2018012220131969bc60ad78ff43a1a0abdd5cd32a0df4.jpg', '1 .jpg', '5a65d55f09bd9904b48fd231', null);
INSERT INTO `imgs` VALUES ('45', 'F201801222013191813275956bf42f3939d440213d1fb4a.jpg', '1.jpg', '5a65d55f09bd9904b48fd231', null);
INSERT INTO `imgs` VALUES ('46', 'F20180122202421d83b3b0dce4a4cbbb555f35edb147425.jpg', '6.jpg', '5a65d7f509bd9904b48fd232', null);
INSERT INTO `imgs` VALUES ('47', 'F2018012220362027ae2f1984884f91aff67e1276f831b4.jpg', '4.jpg', '5a65dac409bd9937c01a10b4', null);
INSERT INTO `imgs` VALUES ('48', 'F20180122204248ed70d6d3362848518896f67338599f4f.jpg', '5.jpg', '5a65dc4809bd992928d4a645', null);
INSERT INTO `imgs` VALUES ('49', 'F20180122215956171c3ab0de3043ba862419663679c123.jpg', '4.jpg', '5a65ee5c09bd992928d4a646', null);
...
CREATE TABLE `orderitems` (
  ...
  PRIMARY KEY (`id`),
  KEY `orders` (`orders`),
  CONSTRAINT `orderitems_ibfk_1` FOREIGN KEY (`orders`) REFERENCES `orders` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=121 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of orderitems
-- ----------------------------
INSERT INTO `orderitems` VALUES ('36', '5a65994934e94c2094386414', '1', '2899', '42');
INSERT INTO `orderitems` VALUES ('37', '5a65d7f509bd9904b48fd232', '1', '899', '43');
INSERT INTO `orderitems` VALUES ('38', '5a65d55f09bd9904b48fd231', '2', '49', '44');
INSERT INTO `orderitems` VALUES ('39', '5a65994934e94c2094386414', '2', '2899', '45');
INSERT INTO `orderitems` VALUES ('40', '5a65d55f09bd9904b48fd231', '1', '49', '46');
INSERT INTO `orderitems` VALUES ('41', '5a65d7f509bd9904b48fd232', '4', '899', '47');
INSERT INTO `orderitems` VALUES ('47', '5a65994934e94c2094386414', '3', '2899', '52');
INSERT INTO `orderitems` VALUES ('65', '5a6599ac34e94c00c440b1c7', '3', '499', '69');
INSERT INTO `orderitems` VALUES ('66', '5a68050ea527be23f809b734', '1', '69', '70');
INSERT INTO `orderitems` VALUES ('67', '5a65d55f09bd9904b48fd231', '1', '49', '70');
INSERT INTO `orderitems` VALUES ('68', '5a6599ba34e94c1a5050696d', '1', '90', '71');
INSERT INTO `orderitems` VALUES ('71', '5a65ee5c09bd992928d4a646', '1', '2699', '73');
INSERT INTO `orderitems` VALUES ('81', '5a6599ba34e94c1a5050696d', '4', '90', '83');
INSERT INTO `orderitems` VALUES ('82', '5a65dac409bd9937c01a10b4', '3', '899', '84');
INSERT INTO `orderitems` VALUES ('83', '5a65ca8509bd990930ec0b05', '1', '239', '85');
INSERT INTO `orderitems` VALUES ('84', '5a65d7f509bd9904b48fd232', '2', '899', '86');
INSERT INTO `orderitems` VALUES ('85', '5a669b806136692ee43c7ba5', '2', '111', '87');
INSERT INTO `orderitems` VALUES ('86', '5a65d55f09bd9904b48fd231', '1', '49', '88');
INSERT INTO `orderitems` VALUES ('87', '5a6599ba34e94c1a5050696d', '1', '90', '89');
INSERT INTO `orderitems` VALUES ('88', '5a65d7f509bd9904b48fd232', '1', '899', '90');
INSERT INTO `orderitems` VALUES ('89', '5a6599ba34e94c1a5050696d', '2', '90', '91');
INSERT INTO `orderitems` VALUES ('90', '5a6599ba34e94c1a5050696d', '1', '90', '92');
INSERT INTO `orderitems` VALUES ('91', '5a65d7f509bd9904b48fd232', '1', '899', '93');
INSERT INTO `orderitems` VALUES ('92', '5a65d55f09bd9904b48fd231', '1', '49', '94');
INSERT INTO `orderitems` VALUES ('93', '5a65994934e94c2094386414', '1', '2899', '95');
INSERT INTO `orderitems` VALUES ('94', '5a65994934e94c2094386414', '1', '2899', '96');
INSERT INTO `orderitems` VALUES ('96', '5a6599ba34e94c1a5050696d', '1', '90', '98');
INSERT INTO `orderitems` VALUES ('101', '5a6599cc34e94c14585b4e59', '1', '168', '103');
INSERT INTO `orderitems` VALUES ('102', '5a6599e234e94c1bb43ca8e8', '1', '5399', '104');
INSERT INTO `orderitems` VALUES ('103', '5a6599cc34e94c14585b4e59', '1', '168', '105');
INSERT INTO `orderitems` VALUES ('104', '5a65d55f09bd9904b48fd231', '1', '49', '106');
INSERT INTO `orderitems` VALUES ('105', '5a65ee5c09bd992928d4a646', '1', '2699', '107');
INSERT INTO `orderitems` VALUES ('106', '5a65d55f09bd9904b48fd231', '1', '49', '108');
INSERT INTO `orderitems` VALUES ('107', '5a65d7f509bd9904b48fd232', '1', '899', '109');
INSERT INTO `orderitems` VALUES ('108', '5a6599ba34e94c1a5050696d', '1', '90', '110');
INSERT INTO `orderitems` VALUES ('111', '5a65ee5c09bd992928d4a646', '2', '2699', '113');
INSERT INTO `orderitems` VALUES ('112', '5a65ee5c09bd992928d4a646', '1', '2699', '114');
INSERT INTO `orderitems` VALUES ('113', '5a65d55f09bd9904b48fd231', '1', '49', '115');
INSERT INTO `orderitems` VALUES ('114', '5a669b806136692ee43c7ba5', '1', '111', '116');
INSERT INTO `orderitems` VALUES ('115', '5a65ee5c09bd992928d4a646', '1', '2699', '117');
INSERT INTO `orderitems` VALUES ('117', '5a6fcafbd5f6532fe089008a', '2', '2000', '119');
INSERT INTO `orderitems` VALUES ('118', '5a6599ba34e94c1a5050696d', '1', '90', '120');
INSERT INTO `orderitems` VALUES ('120', '5a65d7f509bd9904b48fd232', '1', '899', '122');
...
CREATE TABLE `orders` (
  ...
  KEY `status` (`status`),
  KEY `user` (`user`),
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`stores`) REFERENCES `stores` (`id`),
  CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`status`) REFERENCES `status` (`id`),
  CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`user`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=123 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('42', 'O20180124211627', '12', '2899.00', '5', null, null, '3', null, '2018-01-24 21:16:27');
INSERT INTO `orders` VALUES ('43', 'O20180125163146', '12', '899.00', '3', null, null, '3', null, '2018-01-25 16:31:46');
INSERT INTO `orders` VALUES ('44', 'O20180125165709', '36', '98.00', '1', null, null, '11', null, '2018-01-25 16:57:09');
INSERT INTO `orders` VALUES ('45', 'O20180125165709', '36', '5798.00', '5', null, null, '11', null, '2018-01-25 16:57:09');
INSERT INTO `orders` VALUES ('46', 'O20180125170213', '36', '49.00', '1', null, null, '11', null, '2018-01-25 17:02:13');
INSERT INTO `orders` VALUES ('47', 'O20180125170213', '36', '3596.00', '3', null, null, '11', null, '2018-01-25 17:02:13');
INSERT INTO `orders` VALUES ('52', 'O20180126102117', '18', '8697.00', '5', null, null, '2', null, '2018-01-26 10:21:17');
INSERT INTO `orders` VALUES ('69', 'O20180126151606', '18', '1497.00', '3', null, null, '11', null, '2018-01-26 15:16:06');
INSERT INTO `orders` VALUES ('70', 'O20180126151941', '18', '118.20', '1', null, null, '11', null, '2018-01-26 15:19:41');
INSERT INTO `orders` VALUES ('71', 'O20180126151941', '18', '90.00', '2', null, null, '11', null, '2018-01-26 15:19:41');
INSERT INTO `orders` VALUES ('73', 'O20180126152456', '18', '2699.00', '2', null, null, '11', null, '2018-01-26 15:24:56');
INSERT INTO `orders` VALUES ('83', 'O20180127154025', '12', '360.00', '2', null, null, '1', null, '2018-01-27 15:40:25');
INSERT INTO `orders` VALUES ('84', 'O20180127164007', '12', '2697.00', '3', null, null, '1', null, '2018-01-27 16:40:07');
INSERT INTO `orders` VALUES ('85', 'O20180127165108', '12', '239.00', '3', null, null, '1', null, '2018-01-27 16:51:08');
INSERT INTO `orders` VALUES ('86', 'O20180127165723', '12', '1798.00', '3', null, null, '1', null, '2018-01-27 16:57:23');
INSERT INTO `orders` VALUES ('87', 'O20180127170554', '12', '222.00', '5', null, null, '1', null, '2018-01-27 17:05:54');
INSERT INTO `orders` VALUES ('88', 'O20180127170838', '12', '49.00', '1', null, null, '1', null, '2018-01-27 17:08:38');
INSERT INTO `orders` VALUES ('89', 'O20180127171132', '12', '90.00', '2', null, null, '1', null, '2018-01-27 17:11:32');
INSERT INTO `orders` VALUES ('90', 'O20180127171715', '12', '899.00', '3', null, null, '1', null, '2018-01-27 17:17:15');
INSERT INTO `orders` VALUES ('91', 'O20180127172701', '12', '180.00', '2', null, null, '1', null, '2018-01-27 17:27:01');
INSERT INTO `orders` VALUES ('92', 'O20180127172724', '12', '90.00', '2', null, null, '1', null, '2018-01-27 17:27:24');
INSERT INTO `orders` VALUES ('93', 'O20180127172752', '12', '899.00', '3', null, null, '1', null, '2018-01-27 17:27:52');
INSERT INTO `orders` VALUES ('94', 'O20180127173304', '12', '49.00', '1', null, null, '1', null, '2018-01-27 17:33:04');
INSERT INTO `orders` VALUES ('95', 'O20180127173617', '12', '2899.00', '5', null, null, '3', null, '2018-01-27 17:36:17');
INSERT INTO `orders` VALUES ('96', 'O20180127174207', '12', '2899.00', '5', null, null, '3', null, '2018-01-27 17:42:07');
INSERT INTO `orders` VALUES ('98', 'O20180128221548', '18', '90.00', '2', null, null, '2', null, '2018-01-28 22:15:48');
INSERT INTO `orders` VALUES ('103', 'O20180129103931', '18', '168.00', '3', null, null, '1', null, '2018-01-29 10:39:31');
INSERT INTO `orders` VALUES ('104', 'O20180129104248', '18', '5399.00', '1', null, null, '1', null, '2018-01-29 10:42:48');
INSERT INTO `orders` VALUES ('105', 'O20180129105435', '18', '168.00', '3', null, null, '1', null, '2018-01-29 10:54:35');
INSERT INTO `orders` VALUES ('106', 'O20180129105630', '18', '49.00', '1', null, null, '1', null, '2018-01-29 10:56:30');
INSERT INTO `orders` VALUES ('107', 'O20180129112211', '18', '2699.00', '2', null, null, '1', null, '2018-01-29 11:22:11');
INSERT INTO `orders` VALUES ('108', 'O20180129114608', '18', '49.00', '1', null, null, '1', null, '2018-01-29 11:46:08');
INSERT INTO `orders` VALUES ('109', 'O20180129114608', '18', '899.00', '3', null, null, '1', null, '2018-01-29 11:46:08');
INSERT INTO `orders` VALUES ('110', 'O20180129114934', '18', '90.00', '2', null, null, '1', null, '2018-01-29 11:49:34');
INSERT INTO `orders` VALUES ('113', 'O20180129145958', '18', '5398.00', '2', null, null, '1', null, '2018-01-29 14:59:58');
INSERT INTO `orders` VALUES ('114', 'O20180129150005', '18', '2699.00', '2', null, null, '1', null, '2018-01-29 15:00:05');
INSERT INTO `orders` VALUES ('115', 'O20180129150408', '18', '49.00', '1', null, null, '1', null, '2018-01-29 15:04:08');
INSERT INTO `orders` VALUES ('116', 'O20180129150408', '18', '111.00', '5', null, null, '1', null, '2018-01-29 15:04:08');
INSERT INTO `orders` VALUES ('117', 'O20180129151211', '18', '2699.00', '2', null, null, '1', null, '2018-01-29 15:12:11');
INSERT INTO `orders` VALUES ('119', 'O20180606152928', '57', '4000.00', '2', null, null, '2', null, '2018-06-06 15:29:28');
INSERT INTO `orders` VALUES ('120', 'O20180606153213', '57', '90.00', '2', null, null, '2', null, '2018-06-06 15:32:13');
INSERT INTO `orders` VALUES ('122', 'O20180606170455', '57', '899.00', '3', null, null, '2', null, '2018-06-06 17:04:55');
...
-- ----------------------------
INSERT INTO `permission` VALUES ('1', '商品管理', 'admin:goods');
INSERT INTO `permission` VALUES ('2', '订单管理员', 'admin:order');
INSERT INTO `permission` VALUES ('5', '全向测试', 'admin:user');
INSERT INTO `permission` VALUES ('6', '全向测试', 'admin:type');
INSERT INTO `permission` VALUES ('7', '退单管理', 'admin:thorder');
...
-- Records of roles
-- ----------------------------
INSERT INTO `roles` VALUES ('1', '超级管理员', '大猪小猪落玉盘');
INSERT INTO `roles` VALUES ('3', '前台管理员', '订单退订货');

-- ----------------------------
-- Table structure for roles_pers
-- ----------------------------
DROP TABLE IF EXISTS `roles_pers`;
CREATE TABLE `roles_pers` (
  `roles` int(11) NOT NULL,
  `pers` int(11) NOT NULL,
  PRIMARY KEY (`roles`,`pers`),
  KEY `pers` (`pers`),
  CONSTRAINT `roles_pers_ibfk_1` FOREIGN KEY (`roles`) REFERENCES `roles` (`id`),
  CONSTRAINT `roles_pers_ibfk_2` FOREIGN KEY (`pers`) REFERENCES `permission` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of roles_pers
-- ----------------------------
INSERT INTO `roles_pers` VALUES ('1', '1');
INSERT INTO `roles_pers` VALUES ('1', '2');
INSERT INTO `roles_pers` VALUES ('1', '5');
INSERT INTO `roles_pers` VALUES ('1', '6');
INSERT INTO `roles_pers` VALUES ('1', '7');
...
-- Records of series
-- ----------------------------
INSERT INTO `series` VALUES ('1', '豪华精装限量版');
INSERT INTO `series` VALUES ('2', '独具慧眼经典版');
INSERT INTO `series` VALUES ('3', '感恩回馈优惠版');
...
INSERT INTO `status` VALUES ('2', '支付未发货');
INSERT INTO `status` VALUES ('3', '支付已发货');
INSERT INTO `status` VALUES ('4', '支付未发货申请退货');
INSERT INTO `status` VALUES ('5', '支付未发货申请换货');
INSERT INTO `status` VALUES ('6', '支付已发货申请退货');
INSERT INTO `status` VALUES ('7', '支付已发货申请换货');
INSERT INTO `status` VALUES ('8', '已收申请退货');
INSERT INTO `status` VALUES ('9', '已收申请换货');
INSERT INTO `status` VALUES ('10', '未支付取消订单');
INSERT INTO `status` VALUES ('11', '已完成');
INSERT INTO `status` VALUES ('12', '已退货完成');
INSERT INTO `status` VALUES ('13', '已换货完成');
INSERT INTO `status` VALUES ('14', '换货卖家已发出');
...
CREATE TABLE `stores` (
  ...
  KEY `city` (`city`),
  KEY `area` (`area`),
  CONSTRAINT `stores_ibfk_1` FOREIGN KEY (`province`) REFERENCES `province` (`id`),
  CONSTRAINT `stores_ibfk_2` FOREIGN KEY (`city`) REFERENCES `city` (`id`),
  CONSTRAINT `stores_ibfk_3` FOREIGN KEY (`area`) REFERENCES `area` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of stores
-- ----------------------------
INSERT INTO `stores` VALUES ('1', '大润发', '全国连锁最大商城', '9.99', '010-666888', null, null, null, null, null, null);
INSERT INTO `stores` VALUES ('2', '科沃斯自营', '全国连锁', '8.88', '010-888666', null, null, null, null, null, null);
INSERT INTO `stores` VALUES ('3', '世贸商城', '世界连锁', '7.89', '010-879789', null, null, null, null, null, null);
INSERT INTO `stores` VALUES ('4', '小米', '小米官方旗舰店', '8.99', '010-548716', null, null, null, null, null, null);
INSERT INTO `stores` VALUES ('5', 'iPhone', 'iPhone代理店', '9.20', '010-457132', null, null, null, null, null, null);
INSERT INTO `stores` VALUES ('6', 'Nike', 'Nike品牌店', '9.50', '010-475123', null, null, null, null, null, null);
INSERT INTO `stores` VALUES ('7', '华硕', '华硕直营皇家服务中心', '9.80', '010-954756', null, null, null, null, null, null);

-- ----------------------------
-- Table structure for thorderitems
-- ----------------------------
DROP TABLE IF EXISTS `thorderitems`;
CREATE TABLE `thorderitems` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sn` varchar(255) DEFAULT NULL,
  `goods` varchar(255) DEFAULT NULL,
  `num` int(11) DEFAULT NULL,
  `snorders` varchar(11) DEFAULT NULL,
  `yuanyin` varchar(255) DEFAULT NULL,
  `sum` decimal(10,2) DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  `shenhestatus` int(11) DEFAULT NULL,
  `store` int(11) DEFAULT NULL,
  `user` int(11) DEFAULT NULL,
  `creadedate` datetime DEFAULT NULL,
  `modifidate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user` (`user`),
  KEY `thorders` (`snorders`),
  KEY `store` (`store`),
  KEY `status` (`status`),
  CONSTRAINT `thorderitems_ibfk_1` FOREIGN KEY (`user`) REFERENCES `users` (`id`),
  CONSTRAINT `thorderitems_ibfk_3` FOREIGN KEY (`store`) REFERENCES `stores` (`id`),
  CONSTRAINT `thorderitems_ibfk_4` FOREIGN KEY (`status`) REFERENCES `status` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of thorderitems
-- ----------------------------
INSERT INTO `thorderitems` VALUES ('8', 'O20180127213951', '5a68050ea527be23f809b734', null, '70', '不想买了。', null, '8', '1', null, '18', '2018-01-27 21:39:51', null);
INSERT INTO `thorderitems` VALUES ('15', 'O20180128183103', '5a65ee5c09bd992928d4a646', null, '51', '不想买了。', null, '4', '1', null, '18', '2018-01-28 18:31:03', null);
INSERT INTO `thorderitems` VALUES ('16', 'O20180128201818', '5a65d7f509bd9904b48fd232', null, '77', '重复购买了。', null, '4', '1', null, '18', '2018-01-28 20:18:18', null);
INSERT INTO `thorderitems` VALUES ('17', 'O20180128202111', '5a65ee5c09bd992928d4a646', null, '71', '重复购买了。', null, '12', '1', null, '18', '2018-01-28 20:21:11', null);
INSERT INTO `thorderitems` VALUES ('18', 'O20180128210943', '5a68050ea527be23f809b734', null, '70', '不需要了', null, '4', '1', null, '18', '2018-01-28 21:09:43', null);
INSERT INTO `thorderitems` VALUES ('19', 'O20180128212355', '5a6599cc34e94c14585b4e59', null, '72', '不需要了', null, '12', '1', null, '18', '2018-01-28 21:23:55', null);
INSERT INTO `thorderitems` VALUES ('20', 'O20180128212445', '5a6599ba34e94c1a5050696d', null, '68', '不需要了', null, '4', '0', null, '18', '2018-01-28 21:24:45', null);
INSERT INTO `thorderitems` VALUES ('21', 'O20180129125147', '5a65d55f09bd9904b48fd231', null, '58', '重复购买了', null, '6', '0', null, '18', '2018-01-29 12:51:47', null);
INSERT INTO `thorderitems` VALUES ('22', 'O20180129125402', '5a6599cc34e94c14585b4e59', null, '110', '重复购买了', null, '4', '1', null, '18', '2018-01-29 12:54:02', null);
INSERT INTO `thorderitems` VALUES ('23', 'O20180129133525', '5a6599e234e94c1bb43ca8e8', null, '61', '重复购买了', null, '4', '0', null, '18', '2018-01-29 13:35:25', null);

-- ----------------------------
-- Table structure for thorders
-- ----------------------------
DROP TABLE IF EXISTS `thorders`;
CREATE TABLE `thorders` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sn` varchar(255) DEFAULT NULL,
  ...
  KEY `user` (`user`),
  KEY `status` (`status`),
  CONSTRAINT `thorders_ibfk_1` FOREIGN KEY (`order`) REFERENCES `orders` (`id`),
  CONSTRAINT `thorders_ibfk_2` FOREIGN KEY (`store`) REFERENCES `stores` (`id`),
  CONSTRAINT `thorders_ibfk_3` FOREIGN KEY (`user`) REFERENCES `users` (`id`),
  CONSTRAINT `thorders_ibfk_4` FOREIGN KEY (`status`) REFERENCES `status` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of types
-- ----------------------------
INSERT INTO `types` VALUES ('1', '家用电器');
INSERT INTO `types` VALUES ('2', '高科技电子');
INSERT INTO `types` VALUES ('3', '服装品牌');
INSERT INTO `types` VALUES ('4', '护肤美妆');
INSERT INTO `types` VALUES ('5', '食品酒类');
...
CREATE TABLE `users` (
  ...
  `zfpwd` varchar(255) DEFAULT NULL,
  `createdate` datetime DEFAULT NULL,
  `modifidate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `sex` (`sex`),
  ...
  KEY `city` (`city`),
  KEY `area` (`area`),
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`sex`) REFERENCES `sex` (`id`),
  CONSTRAINT `users_ibfk_2` FOREIGN KEY (`province`) REFERENCES `province` (`id`),
  CONSTRAINT `users_ibfk_3` FOREIGN KEY (`city`) REFERENCES `city` (`id`),
  CONSTRAINT `users_ibfk_4` FOREIGN KEY (`area`) REFERENCES `area` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('12', '奥巴马', 'aaa', '74b87337454200d4d33f80c4663dc5e5', 'aaa', '奥巴马', '2', '18340065785', '1', '1', '1', '176881129@qq.com', 'aaa', '2018-01-17 17:03:32', '2018-01-29 18:33:14');
INSERT INTO `users` VALUES ('18', 'aa', 'a', '0cc175b9c0f1b6a831c399e269772661', 'aaa', 'aaa', '1', '13285414944', '1', '1', '1', '135135@qq.com', 'cefccc', '2018-01-25 21:33:14', '2018-01-31 21:33:25');
INSERT INTO `users` VALUES ('36', 'hgfjyfg', 'bb', '21ad0bd836b90d08f4cf640b4c298e7c', null, 'hgjkh', null, '17096872425', '1', '1', '1', null, null, null, null);
INSERT INTO `users` VALUES ('56', null, 'lvjunjiang', '96e79218965eb72c92a549dd5a330112', null, null, null, '13285414943', '1', '1', '1', '1070443459@qq.com', null, null, null);
INSERT INTO `users` VALUES ('57', null, 'liuy', '670b14728ad9902aecba32e22fa4f6bd', null, null, null, '18341893958', '1', '1', '1', '1176881129@qq.com', null, null, null);
